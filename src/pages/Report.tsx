      ...
      <div data-pdf-page="2" className="print-page-break bg-background print:flex print:flex-col print:min-h-[100vh]">
        <div data-pdf-capture="2" className={isMobile ? "p-4" : "p-4 print:p-4 print:pt-4 max-w-[1800px] mx-auto print:min-h-[100vh] print:flex print:flex-col"}>
          ...
          <div className="border border-border rounded-md px-4 py-3 text-center bg-muted/30 mt-3 print:mt-auto print:pt-3 print:pb-1 print:border-x-0 print:border-b-0 print:rounded-none flex items-center justify-center gap-3">
            <img src={bugIconSvg} alt="" className="w-8 h-8 print:w-7 print:h-7 opacity-60 flex-shrink-0" />
            ...
            <img src="/src/assets/icons/bug-icon.svg" alt="" className="w-8 h-8 print:w-7 print:h-7 opacity-60 flex-shrink-0" />
          </div>
        </div>
      </div>
