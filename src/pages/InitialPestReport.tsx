                    ...
                    <div className="flex-1 space-y-0">
                      <div className="flex items-center gap-1">
                        ...
                        <Popover open={techDropdownOpen} onOpenChange={setTechDropdownOpen}>
                          ...
                          <PopoverContent className="w-[200px] p-0 z-50 bg-background border border-border" onOpenAutoFocus={(e) => e.preventDefault()}>
                            <Command>
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <Popover open={techDropdownOpen} onOpenChange={setTechDropdownOpen}>
                      ...
                      <PopoverContent className="w-full p-0 z-50 bg-background border border-border" onOpenAutoFocus={(e) => e.preventDefault()}>
                        <Command>
