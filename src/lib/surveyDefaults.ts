...
export const DEFAULT_ONBOARDING_SURVEY_QUESTIONS: SurveyQuestion[] = [
  ...
  },
  {
    ...
    label: "6. What is your preferred payment method?",
    type: "single",
    options: ["ACH", "Credit Card", "Check", "Other"],
  },
  {
    id: "onb_upset_tenants_frequency",
    label: "7. How often do you have upset tenants because pest issues are going unresolved?",
    type: "single",
    options: [
  ...
  },
  {
    ...
    label: '8. On average, how many weeks pass between the initial treatment and a vacant unit being deemed "free and clear"?',
    type: "single",
    options: [
      "Less than 1 week",
      "1 week",
