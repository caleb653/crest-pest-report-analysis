...
const PRESET_NOTES = [
  { id: "liquid-restaurant-german", label: "Liquid Restaurant German Roach Service", text: "Applied liquid residual to baseboards and harborage areas in kitchen, dining, and bathroom areas. Placed gel bait in cracks, crevices, and high-activity zones, dusted wall voids and outlets, and used aerosol to flush out harborage areas. Monitors placed to track ongoing activity.\n\nPlease do not re-enter the space for at least 4 hours." },
  { id: "fogging-restaurant-german", label: "Fogging Restaurant German Roach Service", text: "Conducted a fogging service to deeply penetrate all areas throughout the kitchen, dining, and bathroom areas. Applied a liquid residual around the baseboards. Monitors placed to track ongoing activity.\n\nPlease do not re-enter the space for at least 4 hours. Please wipe down all accessible food surfaces before food prep." },
  { id: "standard-restaurant", label: "Standard Restaurant Service", text: "Applied liquid residual to baseboards and high-traffic areas in kitchen, dining, and service areas. Monitors placed to track ongoing activity.\n\nPlease allow 2 hours for products to dry." },
