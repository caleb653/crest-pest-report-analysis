...
const PRESET_NOTES = [
  { id: "liquid-restaurant-german", label: "Liquid Restaurant German Roach Service", text: "Applied liquid residual to baseboards and harborage areas in kitchen, dining, and bathrooms. Placed gel bait in cracks, crevices, and high-activity zones, dusted wall voids and outlets, and used aerosol to flush out harborage areas. Monitors placed to track ongoing activity." },
  { id: "fogging-restaurant-german", label: "Fogging Restaurant German Roach Service", text: "Conducted a fogging service to deeply penetrate all areas throughout the kitchen and bathroom areas. Applied a liquid residual around the baseboards. Monitors placed to track ongoing activity." },
